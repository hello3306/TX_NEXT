...
Z([3,'2018 / 美国 / 科幻 动作'])
Z(z[66])
Z([3,'迈克尔·基顿 / 乔治·克鲁尼 / 克里斯蒂安·贝尔 / 本·阿弗莱克'])
Z(z[21])
Z([3,'movie-oper'])
...
Z([3,'片 长 114分钟'])
Z(z[13])
Z([3,'外文名 X-Men: Dark Phoenix'])
Z(z[13])
Z([3,'上映时间 2019年6月6日（中国大陆）2019年6月7日（北美）'])
Z([3,'score-block'])
Z([3,'big-score'])
Z([3,'score-words'])
Z([3,'综合评分:'])
...
Z([3,'请输入搜索的内容'])
Z([3,'text'])
Z([3,'page-block movie-list'])
Z([3,'index'])
Z([3,'img'])
Z([[7],[3,'trailerList']])
Z(z[5])
Z([3,'movie-wapper'])
Z([[4],[[5],[[4],[[5],[[5],[1,'tap']],[[4],[[5],[[4],[[5],[[5],[1,'movie']],[[4],[[5],[[7],[3,'index']]]]]]]]]]]])
Z([3,'poster'])
Z([[7],[3,'img']])
...
var tM=_mz(z,'image',['class',4,'src',1],[],oJ,cI,gg)
_(lK,tM)
return lK
}
hG.wxXCkey=2
_2z(z,3,oH,e,s,gg,hG,'yellow','__i0__','')
var eN=_v()
_(fE,eN)
var bO=function(xQ,oP,oR,gg){
var cT=_mz(z,'image',['class',9,'src',1],[],xQ,oP,gg)
_(oR,cT)
return oR
}
eN.wxXCkey=2
_2z(z,8,bO,e,s,gg,eN,'gray','__i1__','')
var cF=_v()
_(fE,cF)
...
var t1=_mz(z,'image',['class',6,'src',1],[],e,s,gg)
_(aZ,t1)
_(lY,aZ)
var e2=_n('swiper-item')
var b3=_mz(z,'image',['class',8,'src',1],[],e,s,gg)
_(e2,b3)
_(lY,e2)
_(oX,lY)
var o4=_n('view')
...
_(o4,x5)
_(oX,o4)
var h9=_mz(z,'scroll-view',['class',16,'scrollX',1],[],e,s,gg)
var o0=_v()
_(h9,o0)
var cAB=function(lCB,oBB,aDB,gg){
var eFB=_mz(z,'view',['bindtap',21,'class',1,'data-event-opts',2],[],lCB,oBB,gg)
var bGB=_n('view')
_rz(z,bGB,'class',24,lCB,oBB,gg)
var oHB=_mz(z,'image',['class',25,'src',1],[],lCB,oBB,gg)
_(bGB,oHB)
var xIB=_n('view')
...
_(bGB,xIB)
_(eFB,bGB)
var fKB=_mz(z,'trailer-stars',['bind:__l',29,'innerScore',1,'showNum',2,'vueId',3],[],lCB,oBB,gg)
_(eFB,fKB)
_(aDB,eFB)
return aDB
}
o0.wxXCkey=4
_2z(z,20,cAB,e,s,gg,o0,'i','__i0__','')
_(oX,h9)
var cLB=_n('view')
_rz(z,cLB,'class',33,e,s,gg)
var hMB=_n('view')
_rz(z,hMB,'class',34,e,s,gg)
var oNB=_mz(z,'image',['class',35,'src',1],[],e,s,gg)
_(hMB,oNB)
var cOB=_n('view')
...
var oXB=_mz(z,'video',['controls',-1,'class',43,'poster',1,'src',2],[],bUB,eTB,gg)
_(oVB,oXB)
return oVB
}
aRB.wxXCkey=2
_2z(z,42,tSB,e,s,gg,aRB,'t','__i1__','')
_(oX,lQB)
var fYB=_n('view')
_rz(z,fYB,'class',46,e,s,gg)
var cZB=_n('view')
_rz(z,cZB,'class',47,e,s,gg)
var h1B=_mz(z,'image',['class',48,'src',1],[],e,s,gg)
_(cZB,h1B)
var o2B=_n('view')
...
var xAC=_n('view')
_rz(z,xAC,'class',56,t7B,a6B,gg)
var oBC=_mz(z,'image',['class',57,'src',1],[],t7B,a6B,gg)
_(xAC,oBC)
var fCC=_n('view')
_rz(z,fCC,'class',59,t7B,a6B,gg)
var cDC=_n('view')
_rz(z,cDC,'class',60,t7B,a6B,gg)
var hEC=_oz(z,61,t7B,a6B,gg)
_(cDC,hEC)
_(fCC,cDC)
var oFC=_mz(z,'trailer-stars',['bind:__l',62,'innerScore',1,'showNum',2,'vueId',3],[],t7B,a6B,gg)
_(fCC,oFC)
var cGC=_n('view')
_rz(z,cGC,'class',66,t7B,a6B,gg)
var oHC=_oz(z,67,t7B,a6B,gg)
_(cGC,oHC)
_(fCC,cGC)
var lIC=_n('view')
_rz(z,lIC,'class',68,t7B,a6B,gg)
var aJC=_oz(z,69,t7B,a6B,gg)
_(lIC,aJC)
_(fCC,lIC)
_(xAC,fCC)
var tKC=_mz(z,'view',['bindtap',70,'class',1,'data-event-opts',2,'data-gindex',3],[],t7B,a6B,gg)
var eLC=_mz(z,'image',['class',74,'src',1],[],t7B,a6B,gg)
_(tKC,eLC)
var bMC=_n('view')
_rz(z,bMC,'class',76,t7B,a6B,gg)
var oNC=_oz(z,77,t7B,a6B,gg)
_(bMC,oNC)
_(tKC,bMC)
var xOC=_mz(z,'view',['animation',78,'class',1],[],t7B,a6B,gg)
var oPC=_oz(z,80,t7B,a6B,gg)
_(xOC,oPC)
_(tKC,xOC)
_(xAC,tKC)
_(o0B,xAC)
...
o4B.wxXCkey=4
_2z(z,54,l5B,e,s,gg,o4B,'i','gindex','')
_(r,oX)
return r
}
...
var lWC=_mz(z,'video',['controls',-1,'class',2,'id',1,'poster',2,'src',3],[],e,s,gg)
_(oVC,lWC)
_(cUC,oVC)
var aXC=_n('view')
_rz(z,aXC,'class',6,e,s,gg)
var tYC=_mz(z,'image',['class',7,'mode',1,'src',2],[],e,s,gg)
_(aXC,tYC)
var eZC=_n('view')
...
var xGD=_v()
_(oFD,xGD)
if(_oz(z,27,e,s,gg)){xGD.wxVkey=1
var oHD=_mz(z,'trailer-stars',['bind:__l',28,'innerScore',1,'showNum',2,'vueId',3],[],e,s,gg)
_(xGD,oHD)
}
var fID=_n('view')
_rz(z,fID,'class',32,e,s,gg)
var cJD=_oz(z,33,e,s,gg)
_(fID,cJD)
_(oFD,fID)
xGD.wxXCkey=1
xGD.wxXCkey=3
...
var oVD=_mz(z,'image',['class',3,'src',1],[],e,s,gg)
_(xUD,oVD)
_(oTD,xUD)
var fWD=_mz(z,'input',['bindconfirm',5,'class',1,'confirmType',2,'data-event-opts',3,'focus',4,'maxlength',5,'placeholder',6,'type',7],[],e,s,gg)
_(oTD,fWD)
_(bSD,oTD)
var cXD=_n('view')
...
var t5D=_mz(z,'view',['bindtap',17,'class',1,'data-event-opts',2],[],o2D,c1D,gg)
var e6D=_mz(z,'image',['class',20,'src',1],[],o2D,c1D,gg)
_(t5D,e6D)
_(l3D,t5D)
return l3D
}
hYD.wxXCkey=2
_2z(z,16,oZD,e,s,gg,hYD,'img','index','')
_(bSD,cXD)
_(r,bSD)
return r
}
...
__wxAppCode__['components/helloComp.wxss']=undefined;    
